...
import MySubscriptionList from "@components/tableComponents/MySubscriptionList";
...
import SubscriptionPostPaid from "@components/tableComponents/SubscriptionPostPaid";

const SubscriptionPage = () => {
  return (
    <>
      <Head>
        <title>My Subscription | Jobverse</title>
        <meta
          name="description"
...
export enum TabsEnum {
  subscription = "Job Seeker Directory",
  ...
  return (
    <Box mt={{ base: 0, md: 30 }}>
      ...
      <SectionTableContainer>
        {activeTab === TabsEnum.subscription ? (
          <MySubscriptionList />
        ) : (
